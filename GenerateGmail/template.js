 ...
 */
//public class Template {   //    account,   indicator,  indicatorName,  SevenDaysData

    function temptest(){
		 alert('abc');
	}
	
    function Template0(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
                             ) {
          var html= "<br>Dear CS,<br>"+"Thanks for your email and kind help. Please reply this email via the following four steps:  <br>"+
    ...
    function Template1(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>"+
    ...
    function Template2(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template3(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template4(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template5(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template6(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template7(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template8(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template9(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template10(  keyword1,   keyword2,  infrigement,   ROName,
                               ROEmail,   StoreManagerName,   StoreName,  ASIN,
                               title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template11(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template12(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template13(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template14(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template15(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template16(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template17(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
                ...
                "happen again at our Amazon store. If it is possible, Could you write a notification email from "+ ROEmail+" to "+AmazonEmail+" stating that " +
                ...
                "please tell them the related product asins, my store name and email. And also please cc it to me("+SellerEmail+").  <br><br>"+
                "Thank you very much for your understanding and I look forward to hearing from you soon.<br><br>"+
                "Sincerely,<br>"+
                StoreManagerName+
                "Store name:"+StoreManagerName+"<br>"+
                "Store email:"+StoreManagerName+"<br><br>"+
                "==========================<br><br>"+
                "Please forward the email to me if the RO responds you later.  I wish you have a wonderful day!<br>"+
                "Best<br><br>"+
                "Infringement Withdrawing Team<br>";
    ...
    function Template100(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template101(  keyword1,   keyword2,  infrigement,   ROName,
                                 ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                 title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template102(  keyword1,   keyword2,  infrigement,   ROName,
                                 ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                 title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template103(  keyword1,   keyword2,  infrigement,   ROName,
                                 ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                 title,   AmazonEmail,   SellerEmail,   accountName
    ) {
          var html= "<br>Dear CS,<br>" +
    ...
    function Template104(  keyword1,   keyword2,  infrigement,   ROName,
                                ROEmail,   StoreManagerName,   StoreName,  ASIN,
                                title,   AmazonEmail,   SellerEmail,   accountName){
          var html= "<br>Dear CS, <br><br>" +
