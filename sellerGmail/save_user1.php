...
$sql = "insert into accountinfo(ID,ACC,ReceiveDate,OwnerEmail,OwnerName,FirstEmail,ComplaintWithdrawn,Comment,Extra) values('$ID','$ACC','$ReceiveDate','$OwnerEmail','$OwnerName','$FirstEmail','$ComplaintWithdrawn','$Comment','zx')";
@mysql_query($sql);
